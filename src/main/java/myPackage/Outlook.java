...
public class Outlook {
    ...
    public void CreateCalendarEvent(String text) throws UnirestException, FileNotFoundException {
        ...
        String body = "{\"Subject\":\"" + pf.getSubject() + "\"," + "\"Body\": {" + "\"ContentType\": \"HTML\"," + "\"Content\":" + "\"" + 
            pf.getMessage() + "\"" + "}," + "\"Start\": {" + "\"DateTime\":" + "\"" + pf.reformatDate() + pf.getStartTime() + 
            "\"," + "\"TimeZone\": \"Pacific Standard Time\"" + "}," + "\"End\": {" + "\"DateTime\":" + "\"" + 
            pf.reformatDate() + pf.getEndTime() + "\"," + "\"TimeZone\": \"Pacific Standard Time\"" + "}," + "\"Attendees\": [" + 
            "{" + "\"EmailAddress\": {" + "\"Address\": \"TestAcc@eastsidecatholic.org\"" + "}," + "\"Type\": \"Required\"" + "}," + 
            "{" + "\"EmailAddress\": {" + "\"Address\":" + "\"" + pf.getTeacherEmail() + "\"" + "}," + "\"Type\": \"Required\"" + "}" + "]" + "}";
